...
local c = require('base16dd.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Identifier", { fg = c.base05, bg = 'NONE', sp = 'NONE',  })
  ...
  hl(0, "@property", { fg = c.teal, bg = 'NONE' })
  hl(0, "@field", { fg = c.base0D, bg = 'NONE' })
  hl(0, "@parameter", { fg = c.pink, bg = 'NONE' })
  hl(0, "@parameter.reference", { fg = c.pink, bg = 'NONE' })
